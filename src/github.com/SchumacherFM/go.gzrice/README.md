...
This version supports gzip. There are many tools out there which supports embedded files in go with gzip but this one is mine. Especially for learning :-)

appended as zip has been removed. Also the unsafe package part.
